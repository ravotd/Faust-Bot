...
# URLs for comics which do not have a website based random functionality and therefore need a scraper module in modules/comic_scraper.py
# Note: Comics in this List without a scraper in modules/comic_scraper.py will not be scraped and return a No-Scraper-Info in IRC.
